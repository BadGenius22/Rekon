        ...
        >
          {gameDetails.map((game, index) => (
            ...
            >
              ...
              <div
                className={cn(
                  "w-3 h-3 rounded-full mb-3 transition-all duration-300",
                  activeGame === index ? "scale-125" : ""
                )}
                style={{ backgroundColor: game.color }}
              />

              {/* Game name */}
              <div className="font-semibold text-white">{game.shortName}</div>
            ...
            <div>
              <div className="flex items-center gap-3 mb-2">
                <div
                  ...
                  style={{ backgroundColor: gameDetails[activeGame].color }}
                />
                <h3 className="text-2xl font-bold text-white">
                  {gameDetails[activeGame].name}
                </h3>
              </div>
              <p className="text-white/60">{gameDetails[activeGame].description}</p>
            </div>
