        ...
        <div className="grid gap-8 sm:gap-10 grid-cols-2 md:grid-cols-5">
          ...
          <div className="space-y-4 col-span-2 md:col-span-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold text-white tracking-tight">REKON</span>
            </div>
            
            <p className="text-sm leading-relaxed text-white/50 max-w-xs">
              Pro trading terminal for esports prediction markets. Real-time odds. Instant settlements. Powered by Polymarket.
            </p>

            {/* Social Links */}
            <div className="flex items-center gap-2 pt-2">
              <SocialLink href="https://x.com/rekon" label="X (Twitter)">
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </SocialLink>
              <SocialLink href="https://discord.gg/rekon" label="Discord">
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <SocialLink href="https://github.com/rekon" label="GitHub">
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5 text-sm text-white/50">
              ...
              <FooterLink href="/markets?game=lol">League of Legends</FooterLink>
